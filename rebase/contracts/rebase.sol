...
/* this token is a rebase token, with taxes going towards the risk free value wallet, liquidity pool and treasury wallet. 
 
The taxes can be made higher when selling. They are accumulated in the contract before being converted to BNB and distributed.
The rebase function is called externally by an authorized wallet to adjust the total supply.
 
*/ 

contract TokifyRebase is ERC20Detailed, Ownable, MinterRole {
    ...
    string constant _name = "Tokify Rebase";
    string constant _symbol = "TRB";
